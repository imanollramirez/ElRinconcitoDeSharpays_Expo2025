...
import ImageUploadPage from "../components/products/paraiso/registerParaiso";
import ProductsTableP from "../components/products/paraiso/paraisoTable";
...
const SharpaysPage = () => {
  ...
  return (
    ...
    <div className="sharpay-page">
      <Title>El Paraiso De Dios</Title>
