...
const CustomerOrderCard = ({ order }) => {
  const { orderDetails, total, customerId, _id, shippingAddress, createdAt } = order;
    ...
    <div className="order-card">
      <div className="order-header">
        ...
        <div>
          ...
          <p className="order-date" style={{ fontSize: '12px', color: '#666', margin: '2px 0' }}>
      ...
      <div style={{ 
        ...
        <p style={{ margin: "0 0 5px 0" }}>
          <strong>Estado:</strong> Pedido entregado exitosamente
        </p>
        <p style={{ margin: "0" }}>
          <strong>Fecha de entrega:</strong> {formatDate(createdAt)}
        </p>
      </div>
